        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h6 className='text-sxl text-white '>Jadhavar International</h6>
                <p className="text-sm text-gray-400">School & Jr. College</p>
              </div>
            </div>

            <p className="text-gray-400 text-sm">
              Blending traditional values with modern educational practices to nurture future leaders.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/curriculum" className="text-gray-400 hover:text-white transition">Early Years</Link></li>
              <li><Link to="/curriculum" className="text-gray-400 hover:text-white transition">Primary Years</Link></li>
              <li><Link to="/curriculum" className="text-gray-400 hover:text-white transition">Middle Years</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>Email:  jadhavar@gmail.com</li>
            </ul>
